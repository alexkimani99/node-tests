...
router.get('/crearEntrenador', (req, res) => {
    res.render('crearEntrenador'); //nueva vista que llamaremos CrearEntrenador
 })
 ...
 router.post('/', async (req, res) => {
    ...
    try {
        const entrenadorDB = new Entrenador(body) //Creamos un nuevo Pokemon, gracias al modelo
